      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-2xl md:text-4xl font-black text-accent mb-8 uppercase tracking-tight"
          >
            {data.title}
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-16 text-left">
          {data.items.map((item, idx) => (
            ...
            >
              <div className="bg-accent/10 p-2 rounded-lg flex-shrink-0 group-hover:scale-110 transition-transform">
